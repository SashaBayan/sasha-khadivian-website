  ...
  return (
    ...
    >
      ...
      <p className="font-secondary max-w-md text-sm font-light !leading-relaxed md:max-w-lg md:text-base">
        I&apos;m a highly adaptable and versatile technical leader with a
        passion for crafting elegant and efficient solutions to complex
        problems. I have built and maintained software applications and have led
      ...
      <p className="font-secondary max-w-md text-sm font-light !leading-relaxed md:max-w-lg md:text-base">
        ...
        always eager to take on new challenges and continue learning. If
        you&apos;d like to connect, collaborate or discuss opportunities, please
